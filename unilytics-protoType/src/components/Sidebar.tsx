...
const Sidebar: React.FC<SidebarProps> = ({ mobileView = false, onClose = () => {} }) => {
  ...
  return (
    <div className={`flex flex-col h-full bg-white border-r border-gray-200 ${mobileView ? 'w-full' : 'hidden w-60 sm:flex'}`}>
      {/* Mobile close button */}
      {mobileView && (
